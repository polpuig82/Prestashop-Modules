...
var nodoCesta=window["arrayAlternativo"+general+linea];
    ...
    funcion='deshacerItemEC("'+idDesh+'","'+idCambio+'","'+linea+'","'+general+'","'+idElemento+'","'+padre+'")';
    ...
    if(totalPedidosEnCurso!=6) {
        ...
        capaaCambiar.innerHTML='' +
            ...
            '<a class="btn btn-primary" onclick='+funcion+'><img src="/img/cms/deshacer.png" style="width:20px;">DESHACER</a>'+
        ...
        cambiarId(linea,idCambio,general,nodoCesta[posicion].id,padre);
    }

}

function deshacerItemEC(idDesh,idCambio,posicion,general,idElemento,padre)
{
    posicion=posicion-1;
    ...
    $.ajax({
        ...
        success : function(response){
            ...
            capaaCambiar.innerHTML='' +
                ...
                '<a class="btn btn-terciary definido" onClick='+funcion+' style="display: unset; color: #46735C!important;">'+
            ...
            cambiarId(posicion+1,idCambio,general,idCambio,padre);
...
function enviarCambios(num, obId)
{
    ...
    // if (confirmAction) {
        $.ajax({
            url : urlUpdate,
            data : {datosPedido:arrayPedido,numPedido:num,obId:obId},
            method : 'post', //en este caso
            dataType : 'json',
            success : function(response){
                //codigo de exito
...
function addItem(idProduct,qty,numPedido)
{
...
function annadirTramo(json,qty,numPedido,numLineas)
{
    ...
    '<i class="material-icons shopping-cart"><i class="fa fa-trash" aria-hidden="true"style="color: #177343; font-weight: 300;"><p style="display: inline;font-family: Lora; color: #177343; font-size: 12px; font-weight: 300;">&nbsp&nbsp&nbspEliminar</p></i></a> </div></div> </div> </div> </div></div><hr>';
